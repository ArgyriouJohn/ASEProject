...
/**
 * This Activity class enhances the Friend or Place Picker(fb sdk) by adding a title
 * and a confirmation button. The selection results are saved in the AseMapApplication
 * instance.
...
public class PickerActivity extends FragmentActivity 
{
    ...
    {
        AseMapApplication app = (AseMapApplication) getApplication();
        if (FRIEND_PICKER.equals(getIntent().getData())) 
        {
